...
//CFLAGS += -DGPIOTE_ENABLED=1 -DGPIOTE_CONFIG_NUM_OF_LOW_POWER_EVENTS=2 -DGPIOTE_CONFIG_IRQ_PRIORITY=2
//CFLAGS += -DRTC_ENABLED=1 -DRTC_DEFAULT_CONFIG_FREQUENCY=16 -DRTC0_ENABLED=1 -DRTC1_ENABLED=1 -DRTC2_ENABLED=1 -DRTC_DEFAULT_CONFIG_RELIABLE=1 -DRTC_DEFAULT_CONFIG_IRQ_PRIORITY=2 -DNRF_MAXIMUM_LATENCY_US=100
//CFLAGS += -DCLOCK_ENABLED=1 -DCLOCK_CONFIG_XTAL_FREQ=0 -DCLOCK_CONFIG_LF_SRC=0 -D
...
#define RTC_DEFAULT_CONFIG_FREQUENCY 16
#define RTC0_ENABLED 1
#define RTC1_ENABLED 1
#define RTC2_ENABLED 1
#define RTC_DEFAULT_CONFIG_RELIABLE 1
#define RTC_DEFAULT_CONFIG_IRQ_PRIORITY 2
#define NRF_MAXIMUM_LATENCY_US 100
